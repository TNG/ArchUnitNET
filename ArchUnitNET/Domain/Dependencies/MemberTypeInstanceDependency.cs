...
{
    public abstract class MemberTypeInstanceDependency : TypeInstanceDependency, IMemberTypeDependency
    {
        ...
        {
            return Equals(OriginMember, other.OriginMember) && Equals(TargetInstance, other.TargetInstance);
        }
