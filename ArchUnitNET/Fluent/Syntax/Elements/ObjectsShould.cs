...
namespace ArchUnitNET.Fluent.Syntax.Elements
{
        ...
        where TRuleTypeShouldConjunction : SyntaxElement<TRuleType>
    {
        ...
        private TRuleTypeShouldConjunction HaveAttributeWithArguments(IObject<Attribute> attribute, params object[] argumentValues) => AddCondition(ObjectConditionsDefinition<TRuleType>.HaveAttributeWithArguments(attribute, argumentValues));
        ...
        private TRuleTypeShouldConjunction HaveAttributeWithNamedArguments(IObject<Attribute> attribute, IEnumerable<(string, object)> attributeArguments) => AddCondition(ObjectConditionsDefinition<TRuleType>.HaveAttributeWithNamedArguments(attribute, attributeArguments));
        ...
        public TRuleTypeShouldConjunction NotHaveAttributeWithArguments(Attribute attribute, IEnumerable<object> argumentValues) => NotHaveAttributeWithArguments(new Object<Attribute>(attribute), argumentValues);
        public TRuleTypeShouldConjunction NotHaveAttributeWithArguments(Type attribute, IEnumerable<object> argumentValues) => NotHaveAttributeWithArguments(new SystemTypeObject<Attribute>(attribute), argumentValues);
        private TRuleTypeShouldConjunction NotHaveAttributeWithArguments(IObject<Attribute> attribute, IEnumerable<object> argumentValues) => AddCondition(ObjectConditionsDefinition<TRuleType>.NotHaveAttributeWithArguments(attribute, argumentValues));
        ...
        public TRuleTypeShouldConjunction NotHaveAttributeWithNamedArguments(Attribute attribute, params (string, object)[] attributeArguments) => NotHaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction NotHaveAttributeWithNamedArguments(Attribute attribute, IEnumerable<(string, object)> attributeArguments) => NotHaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction NotHaveAttributeWithNamedArguments(Type attribute, params (string, object)[] attributeArguments) => NotHaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction NotHaveAttributeWithNamedArguments(Type attribute, IEnumerable<(string, object)> attributeArguments) => NotHaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        private TRuleTypeShouldConjunction NotHaveAttributeWithNamedArguments(IObject<Attribute> attribute, IEnumerable<(string, object)> attributeArguments) => AddCondition(ObjectConditionsDefinition<TRuleType>.NotHaveAttributeWithNamedArguments(attribute, attributeArguments));
