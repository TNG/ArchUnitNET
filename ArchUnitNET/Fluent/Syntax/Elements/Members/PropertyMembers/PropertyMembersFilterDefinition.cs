...
namespace ArchUnitNET.Fluent.Syntax.Elements.Members.PropertyMembers
{
    public static class PropertyMembersFilterDefinition
    {
        ...
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility == Private, "have private setter");
        }

        public static ObjectFilter<PropertyMember> HavePublicSetter()
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility == Public, "have public setter");
        }

        public static ObjectFilter<PropertyMember> HaveProtectedSetter()
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility == Protected, "have protected setter");
        }

        public static ObjectFilter<PropertyMember> HaveInternalSetter()
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility == Internal, "have internal setter");
        }

        public static ObjectFilter<PropertyMember> HaveProtectedInternalSetter()
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility == ProtectedInternal,
                "have protected internal setter");
        }

        public static ObjectFilter<PropertyMember> HavePrivateProtectedSetter()
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility == PrivateProtected,
        ...
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility != Private,
                "do not have private setter");
        }

        public static ObjectFilter<PropertyMember> DoNotHavePublicSetter()
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility != Public, "do not have public setter");
        }

        public static ObjectFilter<PropertyMember> DoNotHaveProtectedSetter()
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility != Protected,
                "do not have protected setter");
        }

        public static ObjectFilter<PropertyMember> DoNotHaveInternalSetter()
        {
            return new ObjectFilter<PropertyMember>(member => member.Visibility != Internal,
