...
{
    public abstract class AddPropertyMemberPredicate<TRelatedType, TNextElement>
        : AddMemberPredicate<PropertyMember, TRelatedType, TNextElement>,
            IPropertyMemberPredicates<TNextElement, PropertyMember>
