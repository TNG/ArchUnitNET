...
namespace ArchUnitNET.Fluent.Syntax.Elements.Members.MethodMembers
{
    public static class MethodMemberPredicatesDefinition
    {
        ...
        public static IPredicate<MethodMember> HaveReturnType(IObjectProvider<IType> objectProvider)
        {
            IEnumerable<MethodMember> Filter(
            ...
            )
            {
                ...
                return methodMembers.Where(methodMember => isRequiredType(methodMember.ReturnType));
            }
