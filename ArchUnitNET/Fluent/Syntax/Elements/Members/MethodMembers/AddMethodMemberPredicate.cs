...
{
    public abstract class AddMethodMemberPredicate<TRelatedType, TNextElement>
        : AddMemberPredicate<MethodMember, TRelatedType, TNextElement>,
            IMethodMemberPredicates<TNextElement, MethodMember>
