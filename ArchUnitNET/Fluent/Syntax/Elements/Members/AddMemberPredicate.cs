...
{
    public abstract class AddMemberPredicate<TRuleType, TRelatedType, TNextElement>
        : Elements.AddObjectPredicate<TRuleType, TRelatedType, TNextElement>,
            IMemberPredicates<TNextElement, TRuleType>
