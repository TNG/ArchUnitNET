...
namespace ArchUnitNET.Fluent.Syntax.Elements.Members
{
        ...
        where TRuleType : ICanBeAnalyzed
    {
        ...
        public TRuleTypeShouldConjunction AreDeclaredIn(string pattern, bool useRegularExpressions = false)
        {
            _ruleCreator.ContinueComplexCondition(
                MemberPredicatesDefinition<TReferenceType>.AreDeclaredIn(pattern, useRegularExpressions));
            return Create<TRuleTypeShouldConjunction, TRuleType>(_ruleCreator);
        }

        public TRuleTypeShouldConjunction AreDeclaredIn(IEnumerable<string> patterns,
            bool useRegularExpressions = false)
        {
            _ruleCreator.ContinueComplexCondition(
                MemberPredicatesDefinition<TReferenceType>.AreDeclaredIn(patterns, useRegularExpressions));
            return Create<TRuleTypeShouldConjunction, TRuleType>(_ruleCreator);
        }
        ...
        public TRuleTypeShouldConjunction AreNotDeclaredIn(string pattern, bool useRegularExpressions = false)
        {
            _ruleCreator.ContinueComplexCondition(
                MemberPredicatesDefinition<TReferenceType>.AreNotDeclaredIn(pattern, useRegularExpressions));
            return Create<TRuleTypeShouldConjunction, TRuleType>(_ruleCreator);
        }

        public TRuleTypeShouldConjunction AreNotDeclaredIn(IEnumerable<string> patterns,
            bool useRegularExpressions = false)
        {
            _ruleCreator.ContinueComplexCondition(
                MemberPredicatesDefinition<TReferenceType>.AreNotDeclaredIn(patterns, useRegularExpressions));
            return Create<TRuleTypeShouldConjunction, TRuleType>(_ruleCreator);
        }
