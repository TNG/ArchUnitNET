...
{
    public abstract class AddTypePredicate<TRuleType, TRelatedType, TNextElement>
        : AddObjectPredicate<TRuleType, TRelatedType, TNextElement>,
            ITypePredicates<TNextElement, TRuleType>
