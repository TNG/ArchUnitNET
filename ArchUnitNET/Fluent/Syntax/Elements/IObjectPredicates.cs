...
namespace ArchUnitNET.Fluent.Syntax.Elements
{
    public interface IObjectPredicates<out TReturnType>
    {
        ...
        TReturnType DoNotCallAnyMethod(string pattern, bool useRegularExpressions = false);
        TReturnType DoNotCallAnyMethod(IEnumerable<string> patterns, bool useRegularExpressions = false);
        TReturnType DoNotCallAnyMethod(MethodMember method, params MethodMember[] moreMethods);
        TReturnType DoNotCallAnyMethod(IEnumerable<MethodMember> methods);
        TReturnType DoNotCallAnyMethod(IObjectProvider<MethodMember> methods);
