        ...
        where TRuleType : ICanBeAnalyzed
    {
        ...
        public override string Description =>
            PartialArchRuleConjunction != null
                ? $"{PartialArchRuleConjunction.LeftArchRule.Description} {PartialArchRuleConjunction.LogicalConjunction.Description} {ObjectProvider.Description}"
        ...
        public IEnumerable<TRuleType> GetObjects(Architecture architecture)
        {
            ...
            return architecture.GetOrCreateObjects(this, arch => ObjectProvider.GetObjects(arch));
        }
