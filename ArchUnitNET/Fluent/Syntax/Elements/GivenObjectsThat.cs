...
namespace ArchUnitNET.Fluent.Syntax.Elements
{
        ...
        where TRuleType : ICanBeAnalyzed
    {
        ...
        public TGivenRuleTypeConjunction HaveAttributeWithArguments(Attribute attribute, IEnumerable<object> argumentValues) => HaveAttributeWithArguments(new Object<Attribute>(attribute), argumentValues);
        public TGivenRuleTypeConjunction HaveAttributeWithArguments(Type attribute, IEnumerable<object> argumentValues) => HaveAttributeWithArguments(new SystemTypeObject<Attribute>(attribute), argumentValues);
        private TGivenRuleTypeConjunction HaveAttributeWithArguments(IObject<Attribute> attribute, IEnumerable<object> argumentValues) => AddPredicate(ObjectPredicatesDefinition<TRuleType>.HaveAttributeWithArguments(attribute, (IEnumerable<object>)argumentValues));
        ...
        public TGivenRuleTypeConjunction HaveAttributeWithNamedArguments(Attribute attribute, params (string, object)[] attributeArguments) => HaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TGivenRuleTypeConjunction HaveAttributeWithNamedArguments(Attribute attribute, IEnumerable<(string, object)> attributeArguments) => HaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TGivenRuleTypeConjunction HaveAttributeWithNamedArguments(Type attribute, params (string, object)[] attributeArguments) => HaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        public TGivenRuleTypeConjunction HaveAttributeWithNamedArguments(Type attribute, IEnumerable<(string, object)> attributeArguments) => HaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        private TGivenRuleTypeConjunction HaveAttributeWithNamedArguments(IObject<Attribute> attribute, IEnumerable<(string, object)> attributeArguments) => AddPredicate(ObjectPredicatesDefinition<TRuleType>.HaveAttributeWithNamedArguments(attribute, attributeArguments));
        ...
        public TGivenRuleTypeConjunction DoNotHaveAttributeWithArguments(Attribute attribute, IEnumerable<object> argumentValues) => DoNotHaveAttributeWithArguments(new Object<Attribute>(attribute), argumentValues);
        public TGivenRuleTypeConjunction DoNotHaveAttributeWithArguments(Type attribute, IEnumerable<object> argumentValues) => DoNotHaveAttributeWithArguments(new SystemTypeObject<Attribute>(attribute), argumentValues);
        private TGivenRuleTypeConjunction DoNotHaveAttributeWithArguments(IObject<Attribute> attribute, IEnumerable<object> argumentValues) => AddPredicate(ObjectPredicatesDefinition<TRuleType>.DoNotHaveAttributeWithArguments(attribute, argumentValues));
        ...
        public TGivenRuleTypeConjunction DoNotHaveAttributeWithNamedArguments(Attribute attribute, params (string, object)[] attributeArguments) => DoNotHaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TGivenRuleTypeConjunction DoNotHaveAttributeWithNamedArguments(Attribute attribute, IEnumerable<(string, object)> attributeArguments) => DoNotHaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TGivenRuleTypeConjunction DoNotHaveAttributeWithNamedArguments(Type attribute, params (string, object)[] attributeArguments) => DoNotHaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        public TGivenRuleTypeConjunction DoNotHaveAttributeWithNamedArguments(Type attribute, IEnumerable<(string, object)> attributeArguments) => DoNotHaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        private TGivenRuleTypeConjunction DoNotHaveAttributeWithNamedArguments(IObject<Attribute> attribute, IEnumerable<(string, object)> attributeArguments) => AddPredicate(ObjectPredicatesDefinition<TRuleType>.DoNotHaveAttributeWithNamedArguments(attribute, attributeArguments));
