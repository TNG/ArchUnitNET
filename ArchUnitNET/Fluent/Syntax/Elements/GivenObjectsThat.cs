...
namespace ArchUnitNET.Fluent.Syntax.Elements
{
        ...
        where TRuleType : ICanBeAnalyzed
    {
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.Are(firstObject, moreObjects)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.CallAny(method, moreMethods)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DependOnAny(firstType, moreTypes)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        public TGivenRuleTypeConjunction FollowCustomPredicate(
            Func<TRuleType, bool> predicate,
            string description
        )
        {
            _ruleCreator.AddPredicate(
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.OnlyDependOn(firstType, moreTypes)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.OnlyHaveAttributes(attributes)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        public TGivenRuleTypeConjunction HaveAnyAttributesWithArguments(
            IEnumerable<object> argumentValues
        )
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.HaveAnyAttributesWithArguments(argumentValues)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.HaveAnyAttributesWithArguments(
                    firstArgumentValue,
                    moreArgumentValues
                )
            );
        ...
        public TGivenRuleTypeConjunction HaveAnyAttributesWithNamedArguments(
        ...
        public TGivenRuleTypeConjunction HaveName(string pattern, bool useRegularExpressions)
        {
            _ruleCreator.AddPredicate(
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.HaveNameMatching(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        public TGivenRuleTypeConjunction HaveFullName(string pattern, bool useRegularExpressions)
        {
            _ruleCreator.AddPredicate(
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.HaveFullNameMatching(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.HaveNameStartingWith(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.HaveNameEndingWith(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.HaveNameContaining(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.HaveFullNameContaining(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.AreNot(firstObject, moreObjects)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotCallAny(method, moreMethods)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotDependOnAny(firstType, moreTypes)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveAnyAttributes(attributes)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        public TGivenRuleTypeConjunction DoNotHaveAnyAttributesWithNamedArguments(
            IEnumerable<(string, object)> attributeArguments
        )
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveAnyAttributesWithNamedArguments(
                    attributeArguments
                )
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        ...
        public TGivenRuleTypeConjunction DoNotHaveName(string pattern, bool useRegularExpressions)
        {
            _ruleCreator.AddPredicate(
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveNameMatching(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveFullName(fullName)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveFullNameMatching(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveNameStartingWith(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveNameEndingWith(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveNameContaining(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.DoNotHaveFullNameContaining(pattern)
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.AreNotProtectedInternal()
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
        ...
        {
            _ruleCreator.AddPredicate(
                ObjectPredicatesDefinition<TRuleType>.AreNotPrivateProtected()
            );
            return Create<TGivenRuleTypeConjunction, TRuleType>(_ruleCreator);
        }
    }
