...
namespace ArchUnitNET.Fluent.Syntax.Elements
{
        ...
        where TRuleType : ICanBeAnalyzed
    {
        ...
        public TRuleTypeShouldConjunction HaveAttributeWithArguments(Attribute attribute, IEnumerable<object> argumentValues) => HaveAttributeWithArguments(new Object<Attribute>(attribute), argumentValues);
        public TRuleTypeShouldConjunction HaveAttributeWithArguments(Type attribute, IEnumerable<object> argumentValues) => HaveAttributeWithArguments(new SystemTypeObject<Attribute>(attribute), argumentValues);
        private TRuleTypeShouldConjunction HaveAttributeWithArguments(IObject<Attribute> attribute, IEnumerable<object> argumentValues) => ContinueComplexCondition(ObjectPredicatesDefinition<TReferenceType>.HaveAttributeWithArguments(attribute, argumentValues));
        ...
        public TRuleTypeShouldConjunction HaveAttributeWithNamedArguments(Attribute attribute, params (string, object)[] attributeArguments) => HaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction HaveAttributeWithNamedArguments(Attribute attribute, IEnumerable<(string, object)> attributeArguments) => HaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction HaveAttributeWithNamedArguments(Type attribute, params (string, object)[] attributeArguments) => HaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction HaveAttributeWithNamedArguments(Type attribute, IEnumerable<(string, object)> attributeArguments) => HaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        private TRuleTypeShouldConjunction HaveAttributeWithNamedArguments(IObject<Attribute> attribute, IEnumerable<(string, object)> attributeArguments) => ContinueComplexCondition(ObjectPredicatesDefinition<TReferenceType>.HaveAttributeWithNamedArguments(attribute, attributeArguments));
        ...
        public TRuleTypeShouldConjunction DoNotHaveAttributeWithArguments(Attribute attribute, IEnumerable<object> argumentValues) => DoNotHaveAttributeWithArguments(new Object<Attribute>(attribute), argumentValues);
        public TRuleTypeShouldConjunction DoNotHaveAttributeWithArguments(Type attribute, IEnumerable<object> argumentValues) => DoNotHaveAttributeWithArguments(new SystemTypeObject<Attribute>(attribute), argumentValues);
        private TRuleTypeShouldConjunction DoNotHaveAttributeWithArguments(IObject<Attribute> attribute, IEnumerable<object> argumentValues) => ContinueComplexCondition(ObjectPredicatesDefinition<TReferenceType>.DoNotHaveAttributeWithArguments(attribute, argumentValues));
        ...
        public TRuleTypeShouldConjunction DoNotHaveAttributeWithNamedArguments(Attribute attribute, params (string, object)[] attributeArguments) => DoNotHaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction DoNotHaveAttributeWithNamedArguments(Attribute attribute, IEnumerable<(string, object)> attributeArguments) => DoNotHaveAttributeWithNamedArguments(new Object<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction DoNotHaveAttributeWithNamedArguments(Type attribute, params (string, object)[] attributeArguments) => DoNotHaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        public TRuleTypeShouldConjunction DoNotHaveAttributeWithNamedArguments(Type attribute, IEnumerable<(string, object)> attributeArguments) => DoNotHaveAttributeWithNamedArguments(new SystemTypeObject<Attribute>(attribute), attributeArguments);
        private TRuleTypeShouldConjunction DoNotHaveAttributeWithNamedArguments(IObject<Attribute> attribute, IEnumerable<(string, object)> attributeArguments) => ContinueComplexCondition(ObjectPredicatesDefinition<TReferenceType>.DoNotHaveAttributeWithNamedArguments(attribute, attributeArguments));
