...
namespace ArchUnitNETTests.Loader
{
    public class NestedTypesTests
    {
        ...
        public void FindAllNestedTypes()
        {
            Types()
                .That()
                .Are(typeof(Layer1Class.Layer2Class))
                .Should()
                .Exist()
                .Check(Architecture);
            Types()
                .That()
                .Are(typeof(Layer1Class.Layer2Class.Layer3Class1))
                .Should()
                .Exist()
                .Check(Architecture);
            Types()
                .That()
                .Are(typeof(Layer1Class.Layer2Class.Layer3Class1.Layer4Class1))
                .Should()
                .Exist()
                .Check(Architecture);
            Types()
                .That()
                .Are(typeof(Layer1Class.Layer2Class.Layer3Class2))
                .Should()
                .Exist()
                .Check(Architecture);
            Types()
                .That()
                .Are(typeof(Layer1Class.Layer2Class.Layer3Class2.Layer4Class2))
                .Should()
                .Exist()
                .Check(Architecture);
        }
