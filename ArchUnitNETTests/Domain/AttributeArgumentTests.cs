    ...
    public class AttributeArgumentTests
    {
        ...
        public void FluentPredicatesTest()
        {
            ...
            Types()
                ...
                .Are(typeof(ClassWithMultipleAttributesWithParameters))
                .And()
                .HaveAnyAttributesWithNamedArguments(("Parameter2", "param2_1"))
                .Should()
                .Exist()
                .Check(Architecture);
            Types()
            ...
            Types()
                ...
                .Are(typeof(ClassWithMultipleAttributesWithParameters))
                .And()
                .HaveAnyAttributesWithArguments(null)
                .Should()
                .Exist()
                .Check(Architecture);
            Types()
            ...
            Types()
                ...
                .Are(typeof(ClassWithMultipleAttributesWithParameters))
                .And()
                .DoNotHaveAnyAttributesWithNamedArguments(("Parameter2", "param2_1"))
                .Should()
                .NotExist()
                .Check(Architecture);
            Types()
            ...
            Types()
                ...
                .Are(typeof(ClassWithMultipleAttributesWithParameters))
                .And()
                .DoNotHaveAnyAttributesWithArguments(null)
                .Should()
                .NotExist()
                .Check(Architecture);
            Types()
            ...
            Types()
                ...
                .Are(typeof(ClassWithMultipleAttributesWithParameters))
                .And()
                .DoNotHaveAnyAttributesWithNamedArguments(("Parameter2", "param1_1"))
                .Should()
                .Exist()
                .Check(Architecture);
            Types()
        ...
        public void FluentConditionsTest()
        {
            ...
            Types()
                ...
                .Are(typeof(ClassWithMultipleAttributesWithParameters))
                .Should()
                .NotHaveAnyAttributesWithNamedArguments(("Parameter2", "param1_1"))
                .Check(Architecture);
            Types()
                .That()
                .Are(typeof(ClassWithMultipleAttributesWithParameters))
