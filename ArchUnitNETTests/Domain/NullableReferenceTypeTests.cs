...
namespace ArchUnitNETTests.Domain
{
    public class NullableReferenceTypeTests
    {
        ...
        {
            var classUsingNullableReferenceType = Types()
                .That()
                .Are(typeof(ClassUsingNullableReferenceType));

            var classDependsOnlyOnItself = classUsingNullableReferenceType
                .Should()
                .OnlyDependOn(classUsingNullableReferenceType);
