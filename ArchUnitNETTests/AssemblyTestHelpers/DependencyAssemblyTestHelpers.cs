...
public class DependencyAssemblyTestHelpers : AssemblyTestHelper
{
    ...
    public Type BaseClassSystemTypeWithMember = typeof(BaseClassWithMember);

    public Class ChildClassWithMember;
    public Type ChildClassSystemTypeWithMember = typeof(ChildClassWithMember);

    public Class OtherChildClassWithMember;
    public Type OtherChildClassSystemTypeWithMember = typeof(OtherChildClassWithMember);

    public Class BaseClassWithMultipleDependencies;
    public Type BaseClassSystemTypeWithMultipleDependencies =
    ...
    public Type WithMultipleDependenciesSystemType = typeof(ClassWithMultipleDependencies);
    ...
    public DependencyAssemblyTestHelpers()
    {
