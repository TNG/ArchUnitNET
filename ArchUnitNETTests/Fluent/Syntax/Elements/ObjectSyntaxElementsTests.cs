...
public class ObjectSyntaxElementsTests
{
    ...
    public async Task AreTest()
    {
        ...
        {
            Assert.Equal(
                [.. predicate.GetObjects(helper.Architecture)],
                new List<IType> { helper.ChildClass }
            );
        }
        ...
        foreach (var predicate in predicates)
        {
            Assert.Equal(
                [.. predicate.GetObjects(helper.Architecture)],
                new List<IType> { helper.BaseClass, helper.ChildClass }
            );
        }

        // Empty arguments
        Assert.Equal(
            [.. Types().That().Are(new List<IType>()).GetObjects(helper.Architecture)],
            new List<IType>()
        );
        Assert.Equal(
            [.. Types().That().Are([]).GetObjects(helper.Architecture)],
            new List<IType>()
        );
        ...
        should
            .BeTypesThat()
            .Are(Classes().That().Are(helper.ChildClass))
    ...
    public async Task CallAnyTest()
    {
        ...
        should.Be(MethodMembers().That().CallAny([helper.CalledMethod])).AssertNoViolations(helper);
        should
            .Be(MethodMembers().That().CallAny(MethodMembers().That().Are(helper.CalledMethod)))
            .AssertNoViolations(helper);
        ...
        should
            .BeMethodMembersThat()
            .CallAny(MethodMembers().That().Are(helper.CalledMethod))
            .AssertNoViolations(helper);
        ...
        should
            .Be(MethodMembers().That().CallAny([helper.CalledMethod]))
            .AssertOnlyViolations(helper);
        should
            .Be(MethodMembers().That().CallAny(MethodMembers().That().Are(helper.CalledMethod)))
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(MethodMembers().That().CallAny(new List<MethodMember>()))
            .AssertOnlyViolations(helper);
        should
            .Be(
                MethodMembers()
        ...
        should
            .Be(
                MethodMembers()
                    .That()
                    .CallAny(
                        [helper.MethodWithoutDependencies, helper.MethodWithMultipleDependencies]
                    )
            )
            .AssertOnlyViolations(helper);
        should
        ...
        should
            ...
            .AssertNoViolations(helper);
        should
            .Be(MethodMembers().That().CallAny(helper.MethodWithoutDependencies))
            .AssertOnlyViolations(helper);
    ...
    public async Task DependOnAnyTest()
    {
        ...
        should
            .Be(Types().That().DependOnAny(helper.BaseClassSystemType))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DependOnAny(Classes().That().Are(helper.BaseClass)))
            .AssertNoViolations(helper);
        should.Be(Types().That().DependOnAny([helper.BaseClass])).AssertNoViolations(helper);
        should
            .Be(Types().That().DependOnAny([helper.BaseClassSystemType]))
        ...
        should
            .BeTypesThat()
            .DependOnAny(Classes().That().Are(helper.BaseClass))
            .AssertNoViolations(helper);
        should.BeTypesThat().DependOnAny([helper.BaseClass]).AssertNoViolations(helper);
        should.BeTypesThat().DependOnAny([helper.BaseClassSystemType]).AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DependOnAny(helper.ClassWithoutDependencies))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DependOnAny(helper.ClassWithoutDependenciesSystemType))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DependOnAny(Classes().That().Are(helper.ClassWithoutDependencies)))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DependOnAny([helper.ClassWithoutDependencies]))
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DependOnAny(typeof(AttributeNamespace.ClassWithoutAttributes)))
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DependOnAny(helper.ClassWithoutDependencies, helper.BaseClass))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DependOnAny([helper.ClassWithoutDependencies, helper.BaseClass]))
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .DependOnAny(
                        helper.ClassWithoutDependenciesSystemType,
                        helper.BaseClassSystemType
                    )
            )
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .DependOnAny(
                        [helper.ClassWithoutDependenciesSystemType, helper.BaseClassSystemType]
                    )
            )
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DependOnAny([helper.BaseClass, helper.ChildClass]))
            .AssertOnlyViolations(helper);
        ...
        Types()
            ...
            .Are(helper.ChildClass1, helper.ChildClass2)
            .Should()
            .Be(Types().That().DependOnAny(helper.BaseClassWithMultipleDependenciesSystemType))
            .AssertNoViolations(helper);
        Types()
            .That()
            .Are(helper.ChildClass, helper.BaseClass)
    ...
    class CustomPredicate : IPredicate<IType>
    {
        ...
        public IEnumerable<IType> GetMatchingObjects(
            IEnumerable<IType> objects,
            Architecture architecture
        )
        {
    ...
    public async Task FollowCustomPredicateTest()
    {
        ...
        helper.AddSnapshotSubHeader("Conditions");
        should
            .Be(Types().That().FollowCustomPredicate(new CustomPredicate()))
            .AssertNoViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .FollowCustomPredicate(t => t.Name == "ChildClass", "follow custom predicate")
            )
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .FollowCustomPredicate(new CustomPredicate())
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .FollowCustomPredicate(t => t.Name == "ChildClass", "follow custom predicate")
    ...
    public async Task HaveAnyAttributesTest()
    {
        ...
        should.Be(Types().That().HaveAnyAttributes([helper.Attribute1])).AssertNoViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes(helper.Attribute1SystemType))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes([helper.Attribute1SystemType]))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes(Attributes().That().Are(helper.Attribute1)))
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .HaveAnyAttributes(helper.Attribute1SystemType)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .HaveAnyAttributes([helper.Attribute1SystemType])
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAnyAttributes(helper.UnusedAttribute))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes([helper.UnusedAttribute]))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes(helper.UnusedAttributeSystemType))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes([helper.UnusedAttributeSystemType]))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes(Attributes().That().Are(helper.UnusedAttribute)))
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .HaveAnyAttributes([helper.UnusedAttribute])
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .HaveAnyAttributes(helper.UnusedAttributeSystemType)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .HaveAnyAttributes([helper.UnusedAttributeSystemType])
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAnyAttributes(new List<Attribute>()))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes(new List<System.Type>()))
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .HaveAnyAttributes(
                        Attributes().That().HaveFullName(helper.NonExistentObjectName)
                    )
            )
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .HaveAnyAttributes(new List<System.Type>())
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .HaveAnyAttributes(Attributes().That().HaveFullName(helper.NonExistentObjectName))
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAnyAttributes(helper.Attribute1, helper.UnusedAttribute))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributes([helper.Attribute1, helper.UnusedAttribute]))
            .AssertNoViolations(helper);
        ...
        should
            .Be(
                Types()
                    .That()
                    .HaveAnyAttributes(
                        [helper.Attribute1SystemType, helper.UnusedAttributeSystemType]
                    )
            )
            .AssertNoViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .HaveAnyAttributes(
                        Attributes().That().Are(helper.Attribute1, helper.UnusedAttribute)
                    )
            )
            .AssertNoViolations(helper);
        ...
        Types()
            ...
            .Are(helper.ClassWithTwoAttributes, helper.ClassWithThreeAttributes)
            .Should()
            .Be(Types().That().HaveAnyAttributes(helper.Attribute1))
            .AssertNoViolations(helper);
        Types()
            .That()
            .Are(helper.ClassWithTwoAttributes, helper.ClassWithoutAttributes)
    ...
    public async Task HaveAnyAttributesWithArgumentsTest()
    {
        ...
        helper.AddSnapshotSubHeader("Conditions");
        should
            .HaveAnyAttributesWithArguments(helper.Attribute1TypeArgumentSystemType)
            .AssertNoViolations(helper);
        should
            .HaveAnyAttributesWithArguments([helper.Attribute1TypeArgumentSystemType])
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAnyAttributesWithArguments(helper.Attribute1IntegerArgument))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().HaveAnyAttributesWithArguments([helper.Attribute1IntegerArgument]))
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Conditions");
        should
            .HaveAnyAttributesWithArguments(helper.UnusedTypeArgumentSystemType)
            .AssertOnlyViolations(helper);
        should
            .HaveAnyAttributesWithArguments([helper.UnusedTypeArgumentSystemType])
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAnyAttributesWithArguments(helper.UnusedTypeArgumentSystemType))
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types().That().HaveAnyAttributesWithArguments([helper.UnusedTypeArgumentSystemType])
            )
            .AssertOnlyViolations(helper);
        ...
        Types()
            ...
            .Are(helper.ClassWithSingleAttributeWithArguments)
            .Should()
            .Be(Types().That().HaveAnyAttributesWithArguments([]))
            .AssertNoViolations(helper);
        Types()
            .That()
            .Are(helper.ClassWithTwoAttributesWithArguments)
        ...
        Types()
            ...
            .Should()
            .Be(Types().That().HaveAnyAttributesWithArguments(helper.Attribute1StringArgument))
            .AssertNoViolations(helper);
        Types()
            .That()
            .Are(
            ...
            .Should()
            .Be(Types().That().HaveAnyAttributesWithArguments(helper.Attribute2IntegerArgument))
            .AssertAnyViolations(helper);
    ...
    public async Task HaveAnyAttributesWithNamedArguments()
    {
        ...
        should
            .HaveAnyAttributesWithNamedArguments(
                ("NamedParameter1", helper.UnusedTypeArgumentSystemType)
            )
            .AssertOnlyViolations(helper);
        should
            .HaveAnyAttributesWithNamedArguments(
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAnyAttributesWithNamedArguments([]))
            .AssertNoViolations(helper);
    ...
    public async Task HaveAttributeWithArgumentsTest()
    {
        ...
        helper.AddSnapshotSubHeader("Conditions");
        should
            .HaveAttributeWithArguments(helper.Attribute1, helper.UnusedTypeArgumentSystemType)
            .AssertOnlyViolations(helper);
        should
            .HaveAttributeWithArguments(helper.Attribute1, [helper.UnusedTypeArgumentSystemType])
            .AssertOnlyViolations(helper);
        should
            .HaveAttributeWithArguments(
                helper.Attribute1SystemType,
                helper.UnusedTypeArgumentSystemType
            )
            .AssertOnlyViolations(helper);
        should
            .HaveAttributeWithArguments(
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAttributeWithArguments(helper.Attribute1, null))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().HaveAttributeWithArguments(helper.Attribute1SystemType, null))
            .AssertOnlyViolations(helper);

        helper.AddSnapshotSubHeader("Predicates as conditions");
        should
            .BeTypesThat()
            .HaveAttributeWithArguments(helper.Attribute1, null)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .HaveAttributeWithArguments(helper.Attribute1SystemType, null)
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAttributeWithArguments(helper.Attribute1, new List<object>()))
            .AssertNoViolations(helper);
        should
            .Be(
                Types()
    ...
    public async Task HaveAttributeWithNamedArguments()
    {
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().HaveAttributeWithNamedArguments(helper.Attribute1, []))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().HaveAttributeWithNamedArguments(helper.Attribute1SystemType, []))
            .AssertNoViolations(helper);

        helper.AddSnapshotSubHeader("Predicates as conditions");
        should
            .BeTypesThat()
            .HaveAttributeWithNamedArguments(helper.Attribute1, [])
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .HaveAttributeWithNamedArguments(helper.Attribute1SystemType, [])
    ...
    public async Task HaveNameTest()
    {
        ...
        should
            .Be(Types().That().HaveFullName(helper.BaseClass.FullName))
            .AssertNoViolations(helper);
        ...
        should
            .Be(Types().That().HaveFullNameContaining(helper.BaseClass.Namespace.Name))
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .HaveFullNameContaining(helper.BaseClass.Namespace.Name)
            .AssertNoViolations(helper);
    ...
    public async Task NotBeTest()
    {
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().AreNot(helper.ClassWithoutDependencies))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().AreNot(helper.ClassWithoutDependenciesSystemType))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().AreNot(helper.ClassWithoutDependencies))
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .AreNot(helper.ClassWithoutDependenciesSystemType)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .AreNot(Classes().That().Are(helper.ClassWithoutDependencies))
            .AssertNoViolations(helper);
        should.BeTypesThat().AreNot([helper.ClassWithoutDependencies]).AssertNoViolations(helper);
        should
            .BeTypesThat()
        ...
        should
            .Be(Types().That().AreNot(Classes().That().Are(helper.ChildClass)))
            .AssertAnyViolations(helper);
        should.Be(Types().That().AreNot([helper.ChildClass])).AssertAnyViolations(helper);
        should.Be(Types().That().AreNot([helper.ChildClassSystemType])).AssertAnyViolations(helper);
        ...
        should
            .BeTypesThat()
            .AreNot(Classes().That().Are(helper.ChildClass))
            .AssertAnyViolations(helper);
        should.BeTypesThat().AreNot([helper.ChildClass]).AssertAnyViolations(helper);
        should.BeTypesThat().AreNot([helper.ChildClassSystemType]).AssertAnyViolations(helper);
        ...
        should
            .Be(Types().That().AreNot(Classes().That().HaveFullName(helper.NonExistentObjectName)))
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .AreNot(Classes().That().HaveFullName(helper.NonExistentObjectName))
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().AreNot(helper.ClassWithoutDependencies, helper.BaseClass))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().AreNot([helper.ClassWithoutDependencies, helper.BaseClass]))
            .AssertNoViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .AreNot(helper.ClassWithoutDependenciesSystemType, helper.BaseClassSystemType)
            )
            .AssertNoViolations(helper);
        should
            .Be(
        ...
        should
            .BeTypesThat()
            .AreNot(helper.ClassWithoutDependencies, helper.BaseClass)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .AreNot([helper.ClassWithoutDependencies, helper.BaseClass])
    ...
    public async Task NotCallAnyTest()
    {
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(MethodMembers().That().DoNotCallAny(helper.MethodWithoutDependencies))
            .AssertNoViolations(helper);
        should
            .Be(MethodMembers().That().DoNotCallAny([helper.MethodWithoutDependencies]))
            .AssertNoViolations(helper);
        should
            .Be(
                MethodMembers()
                    .That()
                    .DoNotCallAny(MethodMembers().That().Are(helper.MethodWithoutDependencies))
            )
            .AssertNoViolations(helper);
        ...
        should
            .BeMethodMembersThat()
            .DoNotCallAny(helper.MethodWithoutDependencies)
            .AssertNoViolations(helper);
        should
            .BeMethodMembersThat()
            .DoNotCallAny([helper.MethodWithoutDependencies])
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(MethodMembers().That().DoNotCallAny(helper.CalledMethod))
            .AssertOnlyViolations(helper);
        should
            .Be(MethodMembers().That().DoNotCallAny([helper.CalledMethod]))
            .AssertOnlyViolations(helper);
        should
            .Be(
                MethodMembers().That().DoNotCallAny(MethodMembers().That().Are(helper.CalledMethod))
            )
            .AssertOnlyViolations(helper);
        ...
        should
            .BeMethodMembersThat()
            .DoNotCallAny([helper.CalledMethod])
            .AssertOnlyViolations(helper);
        should
            .BeMethodMembersThat()
            .DoNotCallAny(MethodMembers().That().Are(helper.CalledMethod))
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(MethodMembers().That().DoNotCallAny(new List<MethodMember>()))
            .AssertNoViolations(helper);

        helper.AddSnapshotSubHeader("Predicates as conditions");
        should
            .BeMethodMembersThat()
            .DoNotCallAny(new List<MethodMember>())
            .AssertNoViolations(helper);
        ...
        should
            .Be(
                MethodMembers()
                    .That()
                    .DoNotCallAny(helper.CalledMethod, helper.CalledMethod1, helper.CalledMethod2)
            )
            .AssertOnlyViolations(helper);
    ...
    public async Task NotDependOnAnyTest()
    {
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotDependOnAny(helper.ClassWithoutDependencies))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotDependOnAny(helper.ClassWithoutDependenciesSystemType))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotDependOnAny(helper.ClassWithoutDependencies))
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotDependOnAny(helper.ClassWithoutDependencies)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotDependOnAny(helper.ClassWithoutDependenciesSystemType)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotDependOnAny(Classes().That().Are(helper.ClassWithoutDependencies))
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotDependOnAny([helper.ClassWithoutDependencies])
        ...
        should
            .Be(Types().That().DoNotDependOnAny(helper.BaseClassSystemType))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotDependOnAny(Classes().That().Are(helper.BaseClass)))
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotDependOnAny(helper.BaseClassSystemType)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotDependOnAny(Classes().That().Are(helper.BaseClass))
            .AssertOnlyViolations(helper);
        should.BeTypesThat().DoNotDependOnAny([helper.BaseClass]).AssertOnlyViolations(helper);
        should
            .BeTypesThat()
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotDependOnAny(typeof(AttributeNamespace.ClassWithoutAttributes)))
            .AssertNoViolations(helper);

        helper.AddSnapshotSubHeader("Predicates as conditions");
        should
            .BeTypesThat()
            .DoNotDependOnAny(typeof(AttributeNamespace.ClassWithoutAttributes))
            .AssertNoViolations(helper);
        ...
        should
            .Be(Types().That().DoNotDependOnAny(new List<System.Type>()))
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotDependOnAny(helper.ClassWithoutDependencies, helper.BaseClass))
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types().That().DoNotDependOnAny([helper.ClassWithoutDependencies, helper.BaseClass])
            )
            .AssertOnlyViolations(helper);
        should
            .Be(
        ...
        should
            .BeTypesThat()
            .DoNotDependOnAny(helper.ClassWithoutDependencies, helper.BaseClass)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotDependOnAny([helper.ClassWithoutDependencies, helper.BaseClass])
        ...
        should
            .BeTypesThat()
            .DoNotDependOnAny(helper.ClassWithoutDependenciesSystemType, helper.BaseClassSystemType)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotDependOnAny(
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotDependOnAny(helper.BaseClassWithMember, helper.OtherBaseClass))
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types().That().DoNotDependOnAny([helper.BaseClassWithMember, helper.OtherBaseClass])
            )
            .AssertOnlyViolations(helper);
        should
            .Be(
        ...
        should
            .Be(
                Classes().That().DoNotDependOnAny(helper.BaseClassWithMember, helper.OtherBaseClass)
            )
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotDependOnAny(helper.BaseClassWithMember, helper.OtherBaseClass)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotDependOnAny([helper.BaseClassWithMember, helper.OtherBaseClass])
        ...
        should
            .BeTypesThat()
            .DoNotDependOnAny(helper.BaseClassWithMemberSystemType, helper.OtherBaseClassSystemType)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotDependOnAny(
        ...
        should
            .BeTypesThat()
            .DoNotDependOnAny(
                Classes().That().Are(helper.BaseClassWithMember, helper.OtherBaseClass)
            )
            .AssertOnlyViolations(helper);
    ...
    public async Task NotHaveAnyAttributesTest()
    {
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributes(helper.UnusedAttribute))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes([helper.UnusedAttribute]))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes(helper.UnusedAttributeSystemType))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes([helper.UnusedAttributeSystemType]))
            .AssertNoViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributes(Attributes().That().Are(helper.UnusedAttribute))
            )
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(helper.UnusedAttribute)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes([helper.UnusedAttribute])
        ...
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(helper.UnusedAttributeSystemType)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes([helper.UnusedAttributeSystemType])
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributes(helper.Attribute1))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes([helper.Attribute1]))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes(helper.Attribute1SystemType))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes([helper.Attribute1SystemType]))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes(Attributes().That().Are(helper.Attribute1)))
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes([helper.Attribute1])
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(helper.Attribute1SystemType)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes([helper.Attribute1SystemType])
        ...
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(Attributes().That().Are(helper.Attribute1))
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributes(typeof(TypeDependencyNamespace.BaseClass)))
            .AssertNoViolations(helper);

        helper.AddSnapshotSubHeader("Predicates as conditions");
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(typeof(TypeDependencyNamespace.BaseClass))
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributes(new List<Attribute>()))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes(new List<System.Type>()))
            .AssertNoViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributes(
                        Attributes().That().HaveFullName(helper.NonExistentObjectName)
                    )
            )
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(new List<Attribute>())
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(new List<System.Type>())
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(Attributes().That().HaveFullName(helper.NonExistentObjectName))
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributes(helper.Attribute1, helper.Attribute2))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes([helper.Attribute1, helper.Attribute2]))
            .AssertOnlyViolations(helper);
        ...
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributes(
                        [helper.Attribute1SystemType, helper.Attribute2SystemType]
                    )
            )
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributes(
                        Attributes().That().Are(helper.Attribute1, helper.Attribute2)
                    )
            )
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(helper.Attribute1, helper.Attribute2)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes([helper.Attribute1, helper.Attribute2])
        ...
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(helper.Attribute1SystemType, helper.Attribute2SystemType)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes([helper.Attribute1SystemType, helper.Attribute2SystemType])
        ...
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributes(Attributes().That().Are(helper.Attribute1, helper.Attribute2))
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributes(helper.Attribute2))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveAnyAttributes(helper.Attribute1))
            .AssertAnyViolations(helper);
    ...
    public async Task NotHaveAnyAttributesWithArgumentsTest()
    {
        ...
        helper.AddSnapshotSubHeader("Conditions");
        should
            .NotHaveAnyAttributesWithArguments(helper.UnusedTypeArgumentSystemType)
            .AssertNoViolations(helper);
        should
            .NotHaveAnyAttributesWithArguments([helper.UnusedTypeArgumentSystemType])
            .AssertNoViolations(helper);
        ...
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributesWithArguments(helper.UnusedTypeArgumentSystemType)
            )
            .AssertNoViolations(helper);
        should
            .Be(
        ...
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributesWithArguments(helper.UnusedAttributeStringValue)
            )
            .AssertNoViolations(helper);
        should
            .Be(
        ...
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributesWithArguments(helper.Attribute1TypeArgumentSystemType)
            )
            .AssertOnlyViolations(helper);
        should
            .Be(
        ...
        should
            .Be(
                Types().That().DoNotHaveAnyAttributesWithArguments(helper.Attribute1IntegerArgument)
            )
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributesWithArguments([helper.Attribute1IntegerArgument])
            )
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributesWithArguments(helper.Attribute1StringArgument))
            .AssertNoViolations(helper);

        helper.AddSnapshotSubHeader("Predicates as conditions");
        should
            .BeTypesThat()
            .DoNotHaveAnyAttributesWithArguments(helper.Attribute1StringArgument)
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributesWithArguments(null))
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributesWithArguments([]))
            .AssertNoViolations(helper);
        ...
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributesWithArguments(
                        [helper.UnusedTypeArgument, helper.Attribute1StringArgument]
                    )
            )
            .AssertOnlyViolations(helper);
    ...
    public async Task NotHaveAnyAttributesWithNamedArgumentsTest()
    {
        ...
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAnyAttributesWithNamedArguments(
                        ("InvalidName", helper.Attribute1TypeArgumentSystemType)
                    )
            )
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAnyAttributesWithNamedArguments([]))
            .AssertNoViolations(helper);
    ...
    public async Task NotHaveAttributeWithArgumentsTest()
    {
        ...
        should
            .NotHaveAttributeWithArguments(
                helper.Attribute1,
                helper.Attribute2TypeArgumentSystemType
            )
            .AssertNoViolations(helper);
        should
            .NotHaveAttributeWithArguments(
        ...
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithArguments(helper.Attribute1, helper.Attribute2StringArgument)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithArguments(helper.Attribute1, [helper.Attribute2StringArgument])
        ...
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithArguments(helper.Attribute1, helper.Attribute1IntegerArgument)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithArguments(helper.Attribute1, [helper.Attribute1IntegerArgument])
        ...
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAttributeWithArguments(typeof(TypeDependencyNamespace.BaseClass), 1)
            )
            .AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAttributeWithArguments(helper.UnusedAttribute, null))
            .AssertNoViolations(helper);
        should
            .Be(
                Types()
                    .That()
                    .DoNotHaveAttributeWithArguments(helper.UnusedAttributeSystemType, null)
            )
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithArguments(helper.UnusedAttribute, null)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithArguments(helper.UnusedAttributeSystemType, null)
        ...
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithArguments(helper.Attribute1, helper.Attribute1StringArgument)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithArguments(helper.Attribute1, [helper.Attribute1StringArgument])
    ...
    public async Task NotHaveAttributeWithNamedArgumentsTest()
    {
        ...
        should
            .NotHaveAttributeWithNamedArguments(
                helper.Attribute1,
                ("NamedParameter1", helper.Attribute2TypeArgumentSystemType)
            )
            .AssertNoViolations(helper);
        should
            .NotHaveAttributeWithNamedArguments(
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveAttributeWithNamedArguments(helper.Attribute1, []))
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types().That().DoNotHaveAttributeWithNamedArguments(helper.Attribute1SystemType, [])
            )
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithNamedArguments(helper.Attribute1, [])
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveAttributeWithNamedArguments(helper.Attribute1SystemType, [])
            .AssertOnlyViolations(helper);
    ...
    public async Task NotHaveNameTest()
    {
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().DoNotHaveName(helper.BaseClass.FullName))
            .AssertNoViolations(helper);
        should.Be(Types().That().DoNotHaveNameMatching("^.*\\.Base.*$")).AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveFullName(helper.BaseClass.Name))
            .AssertNoViolations(helper);
        should.Be(Types().That().DoNotHaveFullNameMatching("^Base.*$")).AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveNameContaining(helper.BaseClass.Namespace.Name))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveFullNameContaining(helper.NonExistentObjectName))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().DoNotHaveNameStartingWith(helper.BaseClass.Namespace.Name))
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotHaveNameContaining(helper.BaseClass.Namespace.Name)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveFullNameContaining(helper.NonExistentObjectName)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveNameStartingWith(helper.BaseClass.Namespace.Name)
            .AssertNoViolations(helper);
        ...
        should
            .Be(Types().That().DoNotHaveFullName(helper.BaseClass.FullName))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveFullNameMatching("^.*\\.Base.*$"))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveNameContaining(helper.BaseClass.Name))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveFullNameContaining(helper.BaseClass.Namespace.Name))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveNameStartingWith(helper.BaseClass.Name))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().DoNotHaveNameEndingWith(helper.BaseClass.Name))
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .DoNotHaveFullName(helper.BaseClass.FullName)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveFullNameMatching("^.*\\.Base.*$")
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveNameContaining(helper.BaseClass.Name)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveFullNameContaining(helper.BaseClass.Namespace.Name)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveNameStartingWith(helper.BaseClass.Name)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .DoNotHaveNameEndingWith(helper.BaseClass.Name)
            .AssertOnlyViolations(helper);
    ...
    public async Task OnlyDependOnTest()
    {
        ...
        should
            .Be(Types().That().OnlyDependOn(helper.BaseClassSystemType))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().OnlyDependOn(Classes().That().Are(helper.BaseClass)))
            .AssertNoViolations(helper);
        should.Be(Types().That().OnlyDependOn([helper.BaseClass])).AssertNoViolations(helper);
        should
            .Be(Types().That().OnlyDependOn([helper.BaseClassSystemType]))
        ...
        should
            .BeTypesThat()
            .OnlyDependOn(Classes().That().Are(helper.BaseClass))
            .AssertNoViolations(helper);
        should.BeTypesThat().OnlyDependOn([helper.BaseClass]).AssertNoViolations(helper);
        should.BeTypesThat().OnlyDependOn([helper.BaseClassSystemType]).AssertNoViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().OnlyDependOn(typeof(AttributeNamespace.ClassWithoutAttributes)))
            .AssertOnlyViolations(helper);
        ...
        should
            .Be(Types().That().OnlyDependOn(new List<System.Type>()))
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types()
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().OnlyDependOn(helper.BaseClass, helper.OtherBaseClass))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().OnlyDependOn([helper.BaseClass, helper.OtherBaseClass]))
            .AssertOnlyViolations(helper);
        ...
        should
            .BeTypesThat()
            .OnlyDependOn(helper.BaseClass, helper.OtherBaseClass)
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .OnlyDependOn([helper.BaseClass, helper.OtherBaseClass])
    ...
    public async Task OnlyHaveAttributesTest()
    {
        ...
        should
            .Be(Types().That().OnlyHaveAttributes([helper.Attribute1]))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes(helper.Attribute1SystemType))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes([helper.Attribute1SystemType]))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes(Attributes().That().Are(helper.Attribute1)))
            .AssertNoViolations(helper);
        ...
        should
            .BeTypesThat()
            .OnlyHaveAttributes(helper.Attribute1SystemType)
            .AssertNoViolations(helper);
        should
            .BeTypesThat()
            .OnlyHaveAttributes([helper.Attribute1SystemType])
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().OnlyHaveAttributes(helper.UnusedAttribute))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes([helper.UnusedAttribute]))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes(helper.UnusedAttributeSystemType))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes([helper.UnusedAttributeSystemType]))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes(Attributes().That().Are(helper.UnusedAttribute)))
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().OnlyHaveAttributes(typeof(TypeDependencyNamespace.BaseClass)))
            .AssertOnlyViolations(helper);
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().OnlyHaveAttributes(new List<Attribute>()))
            .AssertOnlyViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes(new List<System.Type>()))
            .AssertOnlyViolations(helper);
        should
            .Be(
                Types()
        ...
        should
            .BeTypesThat()
            .OnlyHaveAttributes(new List<System.Type>())
            .AssertOnlyViolations(helper);
        should
            .BeTypesThat()
            .OnlyHaveAttributes(Attributes().That().HaveFullName(helper.NonExistentObjectName))
        ...
        helper.AddSnapshotSubHeader("Predicates");
        should
            .Be(Types().That().OnlyHaveAttributes(helper.Attribute1, helper.Attribute2))
            .AssertNoViolations(helper);
        should
            .Be(Types().That().OnlyHaveAttributes([helper.Attribute1, helper.Attribute2]))
            .AssertNoViolations(helper);
        ...
        should
            .Be(Types().That().OnlyHaveAttributes(helper.Attribute2))
            .AssertOnlyViolations(helper);
