...
namespace ArchUnitNETTests.Fluent.Syntax.Elements
{
    public class LogicalConjunctionTests
    {
        ...
        private static readonly Class ThisClass = Architecture.GetClassOfType(
            typeof(LogicalConjunctionTests)
        );

        private static readonly Class OtherClass = Architecture.GetClassOfType(
            typeof(OtherClassForLogicalConjunctionTest)
        );

        private static readonly string ThisClassName = ThisClass.Name;
        private static readonly string OtherClassName = OtherClass.Name;

        private static readonly IArchRule ThisClassExists = Classes()
            .That()
            .Are(ThisClass)
            .Should()
            .Exist();

        private static readonly IArchRule ThisClassDoesNotExist = Classes()
            .That()
            .Are(ThisClass)
            .Should()
            .NotExist();

        private static readonly IArchRule ThisCondition1 = Classes()
            .That()
            .Are(ThisClass)
            .Should()
            .Be(ThisClass);

        private static readonly IArchRule ThisCondition2 = Classes()
            .That()
            .HaveName(ThisClassName)
            .Should()
            .Be(ThisClass);

        private static readonly IArchRule OtherCondition1 = Classes()
            .That()
            .Are(OtherClass)
            .Should()
            .Be(OtherClass);

        private static readonly IArchRule OtherCondition2 = Classes()
            .That()
            .HaveName(OtherClassName)
            .Should()
            .Be(OtherClass);

        private static readonly IArchRule FalseThisCondition1 = Classes()
            .That()
            .AreNot(ThisClass)
            .Should()
            .Be(ThisClass);

        private static readonly IArchRule FalseThisCondition2 = Classes()
            .That()
            .DoNotHaveName(ThisClassName)
            .Should()
            .Be(ThisClass);

        private static readonly IArchRule ThisShouldCondition1 = Classes()
            .That()
            .Are(ThisClass)
            .Should()
            .Be(ThisClass);

        private static readonly IArchRule ThisShouldCondition2 = Classes()
            .That()
            .Are(ThisClass)
            .Should()
            .HaveName(ThisClassName);

        private static readonly IArchRule OtherShouldCondition1 = Classes()
            .That()
            .Are(OtherClass)
            .Should()
            .Be(OtherClass);

        private static readonly IArchRule OtherShouldCondition2 = Classes()
            .That()
            .Are(OtherClass)
            .Should()
            .HaveName(OtherClassName);

        private static readonly IArchRule FalseThisShouldCondition1 = Classes()
            .That()
            .Are(ThisClass)
            .Should()
            .NotBe(ThisClass);

        private static readonly IArchRule FalseThisShouldCondition2 = Classes()
            .That()
            .Are(ThisClass)
            .Should()
            .NotHaveName(ThisClassName);

        [Fact]
        public void AndShouldTest()
        {
            var thisShouldCondition1AndThisShouldCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Be(ThisClass)
                .AndShould()
                .HaveName(ThisClassName);
            var thisShouldCondition1AndOtherShouldCondition1 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Be(ThisClass)
                .AndShould()
                .Be(OtherClass);
            var otherCondition2AndThisCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .HaveName(OtherClassName)
                .AndShould()
                .HaveName(ThisClassName);
            var falseThisCondition1AndFalseThisCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .NotBe(ThisClass)
            ...
            Assert.False(
                thisShouldCondition1AndOtherShouldCondition1.HasNoViolations(Architecture)
            );
        ...
        public void AndTest()
        {
            var thisCondition1AndThisCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .And()
                .HaveName(ThisClassName)
        ...
        {
            var thisCondition1OrThisCondition2AndOtherCondition1 = Classes()
                .That()
                .Are(ThisClass)
                .Or()
                .HaveName(ThisClassName)
                ...
                .Should()
                .NotExist();
            var thisCondition1AndOtherCondition1OrThisCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .And()
                .Are(OtherClass)
                ...
                .Should()
                .Exist();
            var thisCondition1OrOtherCondition1AndOtherCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Or()
                .Are(OtherClass)
                ...
                .Should()
                .Be(OtherClass);
            var thisCondition1AndThisCondition2OrFalseThisCondition1 = Classes()
                .That()
                .Are(ThisClass)
                .And()
                .HaveName(ThisClassName)
            ...
            Assert.True(
                thisCondition1OrThisCondition2AndOtherCondition1.HasNoViolations(Architecture)
            );
            Assert.True(
                thisCondition1AndOtherCondition1OrThisCondition2.HasNoViolations(Architecture)
            );
            Assert.True(
                thisCondition1OrOtherCondition1AndOtherCondition2.HasNoViolations(Architecture)
            );
            Assert.False(
                thisCondition1AndThisCondition2OrFalseThisCondition1.HasNoViolations(Architecture)
            );
        }
        ...
        {
            var thisShouldCondition1AndOtherShouldCondition1OrThisShouldCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Be(ThisClass)
                ...
                .OrShould()
                .HaveName(ThisClassName);
            var otherShouldCondition1OrThisShouldCondition1AndThisShouldCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Be(OtherClass)
                ...
                .AndShould()
                .HaveName(ThisClassName);
            var thisShouldCondition1OrThisShouldCondition2AndOtherShouldCondition1 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Be(ThisClass)
                ...
                .AndShould()
                .Be(OtherClass);
            var thisShouldExistAndShouldNotExistOrShouldNotExist = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Exist()
                ...
                .OrShould()
                .NotExist();
            var thisShouldExistOrShouldNotExistAndShouldNotExist = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Exist()
                ...
                .AndShould()
                .NotExist();
            var thisShouldExistAndShouldNotExistOrShouldExist = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Exist()
            ...
            Assert.True(
                thisShouldCondition1AndOtherShouldCondition1OrThisShouldCondition2.HasNoViolations(
                    Architecture
                )
            );
            Assert.True(
                otherShouldCondition1OrThisShouldCondition1AndThisShouldCondition2.HasNoViolations(
                    Architecture
                )
            );
            Assert.False(
                thisShouldCondition1OrThisShouldCondition2AndOtherShouldCondition1.HasNoViolations(
                    Architecture
                )
            );
            Assert.False(
                thisShouldExistAndShouldNotExistOrShouldNotExist.HasNoViolations(Architecture)
            );
            Assert.False(
                thisShouldExistOrShouldNotExistAndShouldNotExist.HasNoViolations(Architecture)
            );
            Assert.True(
                thisShouldExistAndShouldNotExistOrShouldExist.HasNoViolations(Architecture)
            );
            Assert.True(
        ...
        {
            var thisClassExistsAndThisClassExists1 = ThisClassExists
                .And()
                .Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Exist();
            var thisClassExistsAndThisClassDoesNotExist1 = ThisClassExists
                .And()
                .Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .NotExist();
            var thisClassDoesNotExistAndThisClassExists1 = ThisClassDoesNotExist
                .And()
                .Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Exist();
            var thisClassDoesNotExistAndThisClassDoesNotExist1 = ThisClassDoesNotExist
                .And()
                .Classes()
                .That()
                .Are(ThisClass)
            ...
            var thisClassExistsAndThisClassDoesNotExist2 = ThisClassExists.And(
                ThisClassDoesNotExist
            );
            var thisClassDoesNotExistAndThisClassExists2 = ThisClassDoesNotExist.And(
                ThisClassExists
            );
            var thisClassDoesNotExistAndThisClassDoesNotExist2 = ThisClassDoesNotExist.And(
                ThisClassDoesNotExist
            );

            var thisClassExistsAndThisClassExistsAndThisClassExists = ThisClassExists.And(
                thisClassExistsAndThisClassExists2
            );
            ...
            var thisClassExistsAndThisClassExistsAndThisClassDoesNotExist = ThisClassExists.And(
                thisClassExistsAndThisClassDoesNotExist2
            );
            ...
            Assert.False(
                thisClassDoesNotExistAndThisClassDoesNotExist1.HasNoViolations(Architecture)
            );
            ...
            Assert.False(
                thisClassDoesNotExistAndThisClassDoesNotExist2.HasNoViolations(Architecture)
            );

            Assert.True(
                thisClassExistsAndThisClassExistsAndThisClassExists.HasNoViolations(Architecture)
            );
            Assert.True(
                thisClassExistsAndThisClassExistsAndThisClassExistsAndThisClassExists.HasNoViolations(
                    Architecture
                )
            );
            Assert.False(
                thisClassExistsAndThisClassExistsAndThisClassDoesNotExist.HasNoViolations(
                    Architecture
                )
            );
            Assert.False(
                thisClassExistsAndThisClassDoesNotExistAndThisClassExists.HasNoViolations(
                    Architecture
                )
            );
            Assert.False(
                thisClassDoesNotExistAndThisClassExistsAndThisClassDoesNotExist.HasNoViolations(
                    Architecture
                )
            );
        }
        ...
        {
            var thisClassExistsAndThisClassExistsOrThisClassExists = ThisClassExists
                .And(Classes().That().Are(ThisClass).Should().Exist())
                .Or()
                .Classes()
                .That()
                .Are(ThisClass)
            ...
            var thisClassExistsOrThisClassDoesNotExistOrThisClassExistsAndThisClassDoesNotExist =
                ThisClassExists
                    .Or(ThisClassDoesNotExist)
                    .Or(ThisClassExists)
                    .And(ThisClassDoesNotExist);
            var thisClassExistsOrThisClassDoesNotExistAndThisClassExists = ThisClassExists
                .Or(ThisClassDoesNotExist)
                .And(ThisClassExists);
            ...
            var thisClassExistsOrThisClassDoesNotExistOrJoinedThisClassExistsAndThisClassDoesNotExist =
                ThisClassExists
                    .Or(ThisClassDoesNotExist)
                    .Or(ThisClassExists.And(ThisClassDoesNotExist));
            var thisClassExistsOrJoinedThisClassDoesNotExistAndThisClassExists = ThisClassExists.Or(
                ThisClassDoesNotExist.And(ThisClassExists)
            );

            Assert.True(
                thisClassExistsAndThisClassExistsOrThisClassExists.HasNoViolations(Architecture)
            );
            Assert.False(
            ...
            Assert.True(
                thisClassExistsOrThisClassDoesNotExistAndThisClassExists.HasNoViolations(
                    Architecture
                )
            );
            Assert.False(
                thisClassDoesNotExistAndThisClassExistsOrThisClassDoesNotExist.HasNoViolations(
                    Architecture
                )
            );
            ...
            Assert.True(
                thisClassExistsOrJoinedThisClassDoesNotExistAndThisClassExists.HasNoViolations(
                    Architecture
                )
            );
        }
        ...
        {
            var thisClassExistsOrThisClassExists1 = ThisClassExists
                .Or()
                .Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Exist();
            var thisClassExistsOrThisClassDoesNotExist1 = ThisClassExists
                .Or()
                .Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .NotExist();
            var thisClassDoesNotExistOrThisClassExists1 = ThisClassDoesNotExist
                .Or()
                .Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Exist();
            var thisClassDoesNotExistOrThisClassDoesNotExist1 = ThisClassDoesNotExist
                .Or()
                .Classes()
                .That()
                .Are(ThisClass)
            ...
            var thisClassDoesNotExistOrThisClassDoesNotExist2 = ThisClassDoesNotExist.Or(
                ThisClassDoesNotExist
            );

            var thisClassExistsOrThisClassExistsOrThisClassExists = ThisClassExists.Or(
                thisClassExistsOrThisClassExists2
            );
            ...
            var thisClassExistsOrThisClassExistsOrThisClassDoesNotExist = ThisClassExists.Or(
            ...
            Assert.False(
                thisClassDoesNotExistOrThisClassDoesNotExist1.HasNoViolations(Architecture)
            );
            ...
            Assert.False(
                thisClassDoesNotExistOrThisClassDoesNotExist2.HasNoViolations(Architecture)
            );

            Assert.True(
                thisClassExistsOrThisClassExistsOrThisClassExists.HasNoViolations(Architecture)
            );
            Assert.True(
                thisClassExistsOrThisClassExistsOrThisClassExistsOrThisClassExists.HasNoViolations(
                    Architecture
                )
            );
            Assert.True(
                thisClassExistsOrThisClassExistsOrThisClassDoesNotExist.HasNoViolations(
                    Architecture
                )
            );
            Assert.True(
                thisClassExistsOrThisClassDoesNotExistOrThisClassExists.HasNoViolations(
                    Architecture
                )
            );
            Assert.False(
                thisClassDoesNotExistOrThisClassDoesNotExistOrThisClassDoesNotExist.HasNoViolations(
                    Architecture
                )
            );
        }
        ...
        {
            var thisShouldCondition1OrThisShouldCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Be(ThisClass)
                .OrShould()
                .HaveName(ThisClassName);
            var thisShouldCondition1OrOtherShouldCondition1 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .Be(ThisClass)
                .OrShould()
                .Be(OtherClass);
            var otherCondition2OrThisCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .HaveName(OtherClassName)
                .OrShould()
                .HaveName(ThisClassName);
            var falseThisCondition1OrFalseThisCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Should()
                .NotBe(ThisClass)
        ...
        public void OrTest()
        {
            var thisCondition1OrThisCondition2 = Classes()
                .That()
                .Are(ThisClass)
                .Or()
                .HaveName(ThisClassName)
                .Should()
                .Be(ThisClass);
            var thisCondition1OrOtherCondition1 = Classes()
                .That()
                .Are(ThisClass)
                .Or()
                .Are(OtherClass)
